        ...
        <div class="mx-5">
            <div class="justify-between">
                <div class="flex items-center">
                    <h2 class="text-3xl text-teal-500 font-bold">Coupon Code</h2>
                </div>
                ...
                <div class="flex justify-center my-6">
                     <inertia-link href="/dashboard/users/create"
                                  class="bg-teal-800 font-medium hover:bg-teal-700 mx-1 px-4 py-2 rounded text-white">
                        Add Coupon
                    </inertia-link>
                </div>
                            ...
                            <table class="min-w-full">
                                ...
                                <tr v-for="coupon in coupons" :key="coupon.index" :class="coupon.used == false ? 'hover:bg-red-300 hover:text-white' : 'hover:bg-teal-200 hover:text-white'">
                                    ...
                                    <td class="flex px-6 py-4 whitespace-no-wrap text-sm leading-5 font-medium">
                                        <svg class="w-6 h-6 text-teal-700" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>

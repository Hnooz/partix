<template>
    <layout>
        <h1 class="my-2 text-gray-500">Dashboard/Comments</h1>
        <div class="mx-5">
            <div class="flex justify-between">
                <div class="flex items-center">
                    <h2 class="text-3xl text-teal-600 font-bold">Comment</h2>
                    <div class="capitalize flex items-center mx-16 text-gray-500">
                         <h1>1.234 total</h1>
                         <div class="flex items-center mx-10">
                             <h1>sort by :</h1>
                             <label for="">
                                 <select class="bg-transparent border-0 capitalize font-medium form-select text-gray-600">
                    ...
                    <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6">
                        <div
                            ...
                            <table class="min-w-full">
                                ...
                                <tr>
                                    <th class="px-6 py-3 border-b border-gray-200 bg-gray-50 text-right text-xs leading-4 text-gray-700 uppercase tracking-wider"
                                    ...
                                    <th class="px-6 py-3 border-b border-gray-200 bg-gray-50 text-xs leading-4 text-gray-700 uppercase tracking-wider"
                                        style="text-align: start">
                                        Product
                                    </th>
                                    <th class="px-6 py-3 border-b border-gray-200 bg-gray-50 text-right text-xs leading-4 text-gray-700 uppercase tracking-wider"
                                ...
                                <tr v-for="comment in comments" :key="comment.index">
                                    ...
                                    <td class="flex px-6 py-4 whitespace-no-wrap text-sm leading-5 font-medium">
                                        ...
                                        <svg v-if="comment.viewed == true" class="w-6 h-6 text-teal-500 mx-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                                        <svg v-if="comment.viewed == false" class="w-6 h-6 text-orange-500 mx-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd"></path></svg>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                comments:[
                    {user:'john doe',comment:'this is test comment',product:'oem',viewed:true,},
                    {user:'john doe',comment:'this is test comment',product:'oem',viewed:false,},
                    {user:'john doe',comment:'this is test comment',product:'oem',viewed:false},
                    {user:'john doe',comment:'this is test comment',product:'oem',viewed:false,},
                    {user:'john doe',comment:'this is test comment',product:'oem',viewed:false},
                    {user:'john doe',comment:'this is test comment',product:'oem',viewed:true,},

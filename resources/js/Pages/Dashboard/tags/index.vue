<template>
    <layout>
        <h1 class="my-2 text-sm text-gray-500 md:text-base">{{__('dashboard')}}/{{__('tags')}}</h1>
        <div class="mt-8 capitalize">
            <div class="flex justify-between">
                <h2 class="text-3xl font-bold text-teal-600">{{__('tags')}}</h2>
                <div class="flex">
            ...
            <div class="mt-4">
                <div class="flex flex-col">
                    ...
                    <paginator-component :data="tags"></paginator-component>
                </div>
            </div>
        </div>
...
import Edit from '../tags/Edit'
    export default {
        ...
        methods: {
            submit() {
                this.$inertia.post('/dashboard/tags', this.form).then(() => {
                    this.form = '';
